  ...
  return (
    <div className='projects' id='projects'>
      ...
      <div className="projects-container">
        <a href='https://github.com/anujsamdariya07/SavvyShop'>
        ...
        <a href='https://github.com/anujsamdariya07/Blogging-Website'>
          <div className="projects-format">
            <h3>02</h3>
        ...
        <a href='https://github.com/anujsamdariya07/Bank-Management-System'>
          <div className="projects-format">
            <h3>03</h3>
